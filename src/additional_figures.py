...
plt.tight_layout()
plt.savefig('figures/figure7_3d_pareto_front.png', dpi=300, bbox_inches='tight')
plt.savefig('figures/figure7_3d_pareto_front.pdf', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('figures/figure8_convergence_plot.png', dpi=300, bbox_inches='tight')
plt.savefig('figures/figure8_convergence_plot.pdf', bbox_inches='tight')
plt.close()
