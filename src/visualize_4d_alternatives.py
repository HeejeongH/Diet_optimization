...
plt.tight_layout()
plt.savefig('figures/4d_visualization/method1_3d_color_mapping.png', dpi=300, bbox_inches='tight')
plt.savefig('figures/4d_visualization/method1_3d_color_mapping.pdf', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('figures/4d_visualization/method2_pairwise_scatter.png', dpi=300, bbox_inches='tight')
plt.savefig('figures/4d_visualization/method2_pairwise_scatter.pdf', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('figures/4d_visualization/method3_parallel_coordinates.png', dpi=300, bbox_inches='tight')
plt.savefig('figures/4d_visualization/method3_parallel_coordinates.pdf', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('figures/4d_visualization/method4_heatmap_matrix.png', dpi=300, bbox_inches='tight')
plt.savefig('figures/4d_visualization/method4_heatmap_matrix.pdf', bbox_inches='tight')
plt.close()
